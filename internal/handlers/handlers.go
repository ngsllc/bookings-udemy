...
// handle post request for reservation form
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "can not insert reservation to database")
		http.Redirect(w, r, "/", http.StatusTemporaryRedirect)
		return
	}
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "can not add room restriction")
		http.Redirect(w, r, "/", http.StatusTemporaryRedirect)
		return
	}
...
func (m *Repository) AvailabilityJSON(w http.ResponseWriter, r *http.Request) {
	...
	available, err := m.DB.SearchAvailabilityByDates(startDate, endDate, roomID)
	if err != nil {
		helpers.ServerError(w, err)
		return
	}
